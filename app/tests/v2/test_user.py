...
class UserTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.test_user7 ={"email":'higi@gmail.com',"password":'12345' }
        self.login_normal_user={"email":"ken@gmail.com","password":"12345"}
        self.test_register_empty_role ={"username":"joan","email": "joana@gmail.com", "password":"123450","role":""}
        self.register_user_existing = {"username":"higi","email": "higi@gmail.com", "password":"12345","role":"Admin"}
    ...
    def test_register_empty_role(self):
        ...
        data = json.dumps(self.test_register_empty_role),
    ...
    def test_register_existing_email(self):
        ...
        response = self.client.post('/api/v2/auth/user',
        data = json.dumps(self.register_user_existing),
        headers=dict(Authorization="Bearer " + token),
        content_type = 'application/json')
        response_data = json.loads(response.data)
